...
class G2PSchemaCultivationCluster:
...
class G2PRegisterSchemaCultivationCluster(G2PRegisterBaseSchema, G2PGeoSchema, G2PSchemaCultivationCluster):
    """
    Schema for CultivationCluster Information register.
    Inherits fields from G2PRegisterBaseSchema, G2PGeoSchema.
    Attributes inherited from G2PSchemaCultivationCluster are specific to the CultivationCluster Information domain.
    """


class G2PRegisterHistorySchemaCultivationCluster(G2PRegisterHistorySchema, G2PGeoHistorySchema, G2PSchemaCultivationCluster):
    """
    Schema for CultivationCluster Information history.
    Inherits fields from G2PRegisterHistorySchema, G2PGeoHistorySchema.
    """


class G2PIntakeFormSchemaCultivationCluster(G2PIntakeFormSchemaBase, G2PRegisterBaseSchema, G2PGeoSchema, G2PSchemaCultivationCluster):
    """
    Schema for CultivationCluster Information intake form.
    Inherits fields from G2PRegisterBaseSchema, G2PGeoSchema.
    Attributes inherited from G2PSchemaCultivationCluster are specific to the CultivationCluster Information domain and are included in the intake form schema for data collection.
    """
